...
**Удаленный репозиторий** - это это репозиторий, размещенный в локальной или интернет сети. Удаленный репозиторий используется для того, чтобы делиться и обмениваться кодом между разработчиками в рамках сети.

## Создание удаленного репозитория 

На сайте GitHub кликните на значок плюса справа сверху.
...
Далее устанавливаем соединение с удаленным репозиторием посредством комманды:

>*git remote add origin <url_репозитория>*

т.е. мы добавляем к нашему локальному репозиторию удаленный репозиторий и связываем их.
...
Операция клонирования создает точную копию удаленного репозитория

>*git clone <ссылка на удаленный репозиторий>*

## Получение изменений из удаленного репозитория
За получение изменений из удаленного репозитория и последующим обновлением рабочей копии отвечает команда:

>*git pull [ключи] [имя удаленного репозитория]*

## Отправка изменений в удаленный репозиторий

За загрузку на удаленный репозиторий локальных изменений отвечает команда:

>*git push [ключи] [имя удаленного репозитория] [имя ветки]*

Можно просто *git push*, если наш локальный репозиторий уже связан с удаленным.
...
Переходим на вкладку *Pull-request* и нажимаем *New pull-request*. 
...
Теперь мы попадаем на страницу наших изменений.
...
git log --graph - позволяет увидеть все логи в со схематичным изображением
