...
* git diff - помогает узнать разницу между сохраненным файлом и добавленным файлом
* git branch <название_ветки> - создать новую ветку
* git checkout -b <название_ветки> - создать новую ветку и переключиться к ней
* git checkout <название_ветки> - переулючаться между ветками
